...
public class PlayerNameEntry extends JDialog {
	...
	public PlayerNameEntry() {
		...
		{
			JLabel lblNewLabel_1 = new JLabel("Player 2 name?");
		...
		}
		{
			...
			public void actionPerformed(ActionEvent arg0){
				 setPlayer1Name(textField.getText().toString());
				 setPlayer2Name(textField_1.getText().toString());
				 dispose();
			}
		});
	...
	public void setPlayer2Name(String y){
		name2 = y;
	}
